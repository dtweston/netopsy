...
extension TLS {
    public struct CipherSuite {
        public enum KeyExchangeAlgorithm {
            case null, rsa, rsaExport, dh, dhe, fortezza, krb5, krb5Export, psk, ecdh, rsaExport1024, vkoGostR341094, vkoGostR34102001, ecdhe, srp
        }

        public enum AuthenticationAlgorithm {
            case null, rsa, rsaExport, dss, anon, kea, krb5, krb5Export, psk, ecdsa, rsaExport1024, vkoGostR341094, vkoGostR34102001, sha
        }

        public enum EncodingAlgorithm {
            case null, rc4_40, rc4_128, rc2_cbc_40, idea_cbc, des40_cbc, des_cbc, des3_ede_cbc, des_cbc_40, fortezza_cbc, aes_128_cbc, aes_256_cbc, camellia_128_cbc, rc4_56, rc2_cbc_56, gost28147, camellia_256_cbc, seed_cbc, aes_128_gcm, aes_256_gcm, des_64_cbc, rc4_64, rc4_128_export40, rc2_cbc_128_cbc, idea_128_cbc
        }

        public enum MacAlgorithm {
            case null, md5, sha, sha256, gost28147, gostr3411, sha384
        }

        public enum RawCipherSuite {
            case unknown
            case unassigned
            case reserved
            ...
            var tlsProtocol: String {
                switch self {
                case .reserved, .reservedPrivate, .unassigned, .unknown:
                    return "unknown"
                default: return "Tls"
                }
            }
        ...
        public var suite: RawCipherSuite
        public var keyExchange: KeyExchangeAlgorithm
        public var authentication: AuthenticationAlgorithm
        public var encoding: EncodingAlgorithm
        public var mac: MacAlgorithm

        private static let map: [UInt16: RawCipherSuite] = [
        ...
        public init(rawValue: UInt16) {
            ...
            let cipherSuite: RawCipherSuite = {
                switch rawValue {
                case 0x1c...0x1d:
                    return .reserved
                case 0x47...0x5c:
                ...
                default:
                    return CipherSuite.map[rawValue] ?? .unknown
                }
            }()
            ...
            self.keyExchange = .dh
            self.authentication = .anon
            self.encoding = .aes_128_cbc
            self.mac = .gost28147
        }
    }
}
